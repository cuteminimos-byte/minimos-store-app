...
export default function AccessoriesPage() {
  ...
  return (
    <div className="w-full min-h-screen py-16 px-4 md:px-8 max-w-[1200px] mx-auto">
      ...
      {/* 2. IMAGES GRID: EXACT 2 UPAR, 2 NEECHE - SHIFTED TO LEFT (mr-auto) */}
      <div className="grid grid-cols-2 gap-4 md:gap-6 max-w-[700px] mr-auto">
        {products.map((product) => (
          ...
          >
            ...
            {/* Dark Shading for text visibility */}
            <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent z-10 pointer-events-none" />

            {/* Title (Bottom Left matching image_2a7f5d.png) */}
